...
public class alterarContatoServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -1232418302893231575L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			Optional<Contato> contatoSelecionado = contatos.stream().filter(c -> c.getId() == idContato).findFirst();
